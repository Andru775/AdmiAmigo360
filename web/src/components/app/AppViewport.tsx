...
export function AppViewport({ children, currentNav }: AppViewportProps) {
  return (
    ...
    >
      <div
        className="relative mx-auto flex h-full min-h-0 w-full max-w-[430px] flex-col overflow-hidden bg-[linear-gradient(180deg,var(--app-shell)_0%,var(--app-shell-strong)_100%)] sm:max-h-[844px] sm:rounded-[42px] sm:border sm:border-[var(--app-card-border)] sm:shadow-[0_28px_62px_rgba(71,51,41,0.16)]"
      >
        {children}
